        ...
        <table class="payments-table">
            ...
            <tbody>
                ...
                <tr class="pending-row">
                    ...
                    <td><?php echo $row['appointment_date'] ? date('M d, Y', strtotime($row['appointment_date'])) . ' ' . date('h:i A', strtotime($row['appointment_time'])) : 'N/A'; ?>
                    </td>
        ...
        <table class="payments-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $row['paid_at'] ? date('M d, Y h:i A', strtotime($row['paid_at'])) : 'N/A'; ?></td>
                    <td>
                        <?php if ($row['paid_at']): ?>
